  ...
  ui.createMenu("Programación")
    .addSubMenu(
      ui.createMenu("Templates")
        ...
        .addItem("Enviar a maestro","actualizar_maestro")
...
function extaer_datos_maestro(){
  ...
  const titulos=["CODIGO","SECCION","TITULO","RUT PROFESOR","NOMBRE PROFESOR","SALA ESPECIAL","TIPO","SEMESTRE PLAN COMUN"
  ,"LUNES","MARTES","MIERCOLES","JUEVES","VIERNES"]
  const hoja_bloques=hojasActuales.getSheetByName("DATOS MAESTRO")
  const datos_antiguos=hoja_bloques.getDataRange().getDisplayValues()
  ...
  const bloques=obtener_bloques(data_maestro,encabezado_maestro,datos_antiguos)
  
  hoja_bloques.clear()
  hoja_detalles_malla.clear()
  escribirListaDeListas(hoja_bloques,[titulos,...bloques[0]],1,1,hoja_salas_especiales,1)
